		...
		<div class="container-login100">
			...
			<a href="../nm.php"><i class="fa fa-arrow-circle-left w3-right" style="font-size:36px;"></i></a>
				...
				<form class="login100-form validate-form" action="" method="post">
					...
					<div class="wrap-input100 validate-input" data-validate = "Valid Username is required: ex@appleguwahati">
				...
				if(isset($_POST['login']))
				{
					...
					session_start();
					//$_SESSION['user']=$roll;
					$sql="SELECT ID from company_login where username='$roll' and Password='$pass' and validity='1'";
